...
const gameMeta={ladder:['🪜','사다리 타기'],bingo:['⭕','빙고'],dodge:['💩','똥피하기'],race:['🏎️','레이싱'],timing:['⏱️','타이밍 게임'],liar:['🕵️','라이어 게임'],bomb:['💣','폭탄 돌리기'],memory:['🃏','카드 뒤집기'],gomoku:['⚫','오목']};
...
function desc(k){return {ladder:'운명을 따라 내려가기',bingo:'3×3 · 4×4 · 5×5 선택',dodge:'실시간 생존 게임',race:'스페이스바 연타 대결',timing:'5~10초 랜덤 타이밍 맞추기',liar:'3라운드 설명 후 라이어 찾기',bomb:'폭탄을 넘기고 끝까지 생존',memory:'같은 그림을 찾아 점수 대결',gomoku:'두 명이 겨루는 오목'}[k]}
...
function gameView(){const r=state.room;return {ladder:ladderView,bingo:bingoView,dodge:dodgeView,race:raceView,timing:timingView,liar:liarView,bomb:bombView,memory:memoryView,gomoku:gomokuView}[r.game]()}
